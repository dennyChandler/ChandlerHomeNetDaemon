namespace ChandlerHome.apps.HassModel
{
    public class Home
    {
        ...
        public virtual void TurnOn(LightEntity light, int brightnessPercent, int transition, object? colorName = null, bool doesOverrideMatter = true, string? effect=null, object? rgbwwColor = null, long? kelvin= null)
        {
            if (!IsVacationModeOn())
            {
